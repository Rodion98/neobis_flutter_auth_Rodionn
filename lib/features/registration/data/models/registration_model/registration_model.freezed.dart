...
class _$RegistrationModelImpl implements _RegistrationModel {
  ...
  @override
  String toString() {
    return 'RegistrationModel(username: $username, email: $email, password: $password, passwordConfirm: $passwordConfirm)';
  }
...
abstract class _RegistrationModel implements RegistrationModel {
  const factory _RegistrationModel(
      ...
      @JsonKey(name: 'password_confirm')
      required final String passwordConfirm}) = _$RegistrationModelImpl;
